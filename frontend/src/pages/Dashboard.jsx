        ...
        <div style={S.searchCard}>
          <div style={S.formGrid}>
            ...
            <div style={{ ...S.field, justifyContent: "flex-end" }}>
              ...
              <button style={loading ? { ...S.btnPrimary, opacity: 0.55, cursor: "not-allowed" } : S.btnPrimary}
          ...
          <div>
            ...
            <div style={S.tableWrap}>
              <table style={S.table}>
                <thead>
                  <tr>
                    {["#","Name","Category","Rating","Reviews","Phone","Address","Website","Hours","Map","Actions"].map(h => (
                ...
                <tbody>
                  {filtered.length === 0 ? (
                    ...
                    <tr key={i} style={S.tr}
                      ...
                      {/* ✅ Actions column */}
                      <td style={S.td}>
                        <button style={S.detailBtn} onClick={() => openDetails(r)}>
                          Details&nbsp;<IconArrow />
                        </button>
...
const S = {
  ...
  label: { fontSize:"0.7rem", fontWeight:600, color:"#4a5a7a", textTransform:"uppercase", letterSpacing:"0.08em", marginBottom:"0.4rem" },
  input: { background:"#080c14", border:"1.5px solid #1c2540", borderRadius:8, padding:"0.65rem 0.9rem", color:"#dde3ee", fontFamily:"Inter,sans-serif", fontSize:"0.9rem", outline:"none" },
  select: { background:"#080c14", border:"1.5px solid #1c2540", borderRadius:8, padding:"0.65rem 0.9rem", color:"#dde3ee", fontFamily:"Inter,sans-serif", fontSize:"0.9rem", outline:"none" },
  ...
  detailBtn: { display:"inline-flex", alignItems:"center", gap:5, padding:"0.38rem 0.8rem", background:"linear-gradient(135deg,#4f8ef7,#3370d4)", color:"#fff", border:"none", borderRadius:6, fontSize:"0.77rem", fontWeight:600, cursor:"pointer", whiteSpace:"nowrap", letterSpacing:"0.01em" },
